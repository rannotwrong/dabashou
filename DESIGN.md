...
导航为文本标签，主操作为胶囊按钮。推荐以单张浅灰交换卡纵向浏览；所有头像为中性灰。表单保留原生控件及 dialog，圆角不超过 16px。

## Layout and motion

1120px 内容宽度，留白集中在标题与工作区之间。桌面左侧选择个人交换卡、右侧纵向浏览候选；移动端上下堆叠，个人卡横向滚动。交互过渡 180ms，减少动态效果时禁用。
